...
@section('content')
            ...
            <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">                
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="integer" class="form-control" placeholder="Project Space" name="space">
                        @error("space")
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>   
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="integer" class="form-control" placeholder="Total Units" name="total_units">
                        @error("total_units")
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>     
    ...
    {{--  ################################################ Project Images #####################  --}}
        ...
        <div class="card-body">
             ...
             {{--  IMAGES FORM  --}}
             <form class="form-image" action="{{ route('pro.images',$lastPro) }}"
                method="post" enctype="multipart/form-data">
                @csrf 

                <div class="form-body">

                    <h4 class="form-section"><i class="ft-home"></i>  Project Images </h4>
